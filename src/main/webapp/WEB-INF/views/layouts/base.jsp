...
<head>
    ...
    <meta name="description" content="Luminary is a clothing shop">
    ...
    <!-- Default CSS -->
    <link rel="stylesheet" type="text/css" href="${BASE_URL}assets/css/demo3.min.css">
</head>

<body class="home">
<div class="page-wrapper">
    <h1 class="d-none">Luminary - Clothing</h1>

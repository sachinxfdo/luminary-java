                ...
                <div class="row gutter-lg mb-10">
                    <div class="col-lg-8 pr-lg-4 mb-6">
                        <table class="shop-table cart-table">
                            ...
                            <tbody>
                            <c:forEach items="${model}" var="cartItem">
                            <tr>
                                <td class="product-thumbnail">
                                    <div class="p-relative">
                                        <a href="product-default.html">
                                            <figure>
                                                <img src="${cartItem.product.getThumbnail()}" alt="product"
                                ...
                                <td class="product-price"><span class="amount">$${cartItem.product.getPrice()}</span></td>

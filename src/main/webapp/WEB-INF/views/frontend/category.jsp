                ...
                <div class="product text-center">
                  <figure class="product-media">
                    <a href="product-default.html">
                      <img src="${product.getThumbnail()}" alt="Product" width="300"
                           height="338" />
                    </a>
                  ...
                  <div class="product-details">
                    <div class="product-cat">
                      <a href="shop-banner-sidebar.html">${product.category.getName()}</a>
                    </div>
                    <h3 class="product-name">
                      <a href="product-default.html">${product.getName()}</a>
                    </h3>
